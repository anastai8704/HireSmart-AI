...
import { CubeMark, Logo, LogoMark } from "./Logo";
...
describe("Brand Logo Component", () => {
  ...
  it("renders compact CubeMark when showWordmark is false", () => {
  ...
  it("renders standalone CubeMark as a high-fidelity faceted geometric mark", () => {
    render(<CubeMark className="h-8 w-8" title="HireSmart AI Cube" />);
    const mark = screen.getByRole("img", { name: "HireSmart AI Cube" });
    expect(mark).toBeInTheDocument();
    expect(mark.querySelector("#faceted-cube-mark")).toBeInTheDocument();
  });
});
