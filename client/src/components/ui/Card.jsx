// Content surface, exported as a small family (Card / CardHeader / CardTitle / ...).
...
export const CardTitle = ({ className, as: Component = "h3", children, ...props }) => (
  <Component className={cn("text-base font-semibold text-ink-900", className)} {...props}>
    {children}
  </Component>
);
...
export const CardFooter = ({ className, children, ...props }) => (
  <div
    className={cn("flex items-center gap-3 border-t border-ink-100 p-5 pt-4", className)}
    {...props}
  >
    {children}
  </div>
