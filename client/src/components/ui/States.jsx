 ...
 *
 * WHY THESE DESERVE REAL COMPONENTS
 * Junior projects render nothing while data loads, then pop content in. That
 * feels broken. Production apps always answer three questions:
 *   "Is something happening?"  -> Skeleton / Spinner
 *   "Is there genuinely nothing here?" -> EmptyState with a next action
 *   "Did it break, and can I retry?"   -> ErrorState with a retry button
 */
