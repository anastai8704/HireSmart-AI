...
export const interviewApi = {
  list: (orgId, params) => api.get(`/organizations/${orgId}/interviews${query(params)}`), create: (orgId, body) => api.post(`/organizations/${orgId}/interviews`, body), update: (orgId, id, body) => api.patch(`/organizations/${orgId}/interviews/${id}`, body),
