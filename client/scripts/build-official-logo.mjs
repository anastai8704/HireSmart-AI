...
function createLogoSvg(tone = "light") {
  ...
  <defs>
    <linearGradient id="hs-facet-cyan-top-${tone}" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#bae6fd" />
      <stop offset="100%" stop-color="#38bdf8" />
    </linearGradient>
    <linearGradient id="hs-facet-cyan-mid-${tone}" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#38bdf8" />
      <stop offset="100%" stop-color="#0284c7" />
    </linearGradient>
    <linearGradient id="hs-facet-cyan-glow-${tone}" x1="100%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stop-color="#67e8f9" />
      <stop offset="100%" stop-color="#0ea5e9" />
    </linearGradient>
    <linearGradient id="hs-facet-blue-left-${tone}" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#0ea5e9" />
      <stop offset="100%" stop-color="#0369a1" />
    </linearGradient>
    <linearGradient id="hs-facet-blue-deep-${tone}" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#0284c7" />
      <stop offset="100%" stop-color="#0c4a6e" />
    </linearGradient>
    <linearGradient id="hs-facet-blue-right-${tone}" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#2563eb" />
      <stop offset="100%" stop-color="#1e40af" />
    </linearGradient>
    <linearGradient id="hs-facet-blue-dark-${tone}" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <g id="hiresmart-logo-content">
    ...
    <g id="faceted-cube">
      <!-- Top Section -->
      <polygon points="${pTop} ${midTopLeft} ${midCenterTop}" fill="url(#hs-facet-cyan-top-${tone})" />
      <polygon points="${pTop} ${midTopRight} ${midCenterTop}" fill="url(#hs-facet-cyan-mid-${tone})" />
      <polygon points="${midTopLeft} ${pTopLeft} ${pCenter} ${midCenterTop}" fill="url(#hs-facet-cyan-glow-${tone})" />
      <polygon points="${midTopRight} ${pTopRight} ${pCenter} ${midCenterTop}" fill="url(#hs-facet-cyan-top-${tone})" />

      <!-- Left Section -->
      <polygon points="${pTopLeft} ${midLeft} ${pCenter}" fill="url(#hs-facet-cyan-mid-${tone})" />
      <polygon points="${midLeft} ${pBottomLeft} ${midCenterLeft} ${pCenter}" fill="url(#hs-facet-blue-left-${tone})" />
      <polygon points="${pBottomLeft} ${midBottomLeft} ${pCenter}" fill="url(#hs-facet-blue-deep-${tone})" />
      <polygon points="${midBottomLeft} ${pBottom} ${pCenter}" fill="url(#hs-facet-blue-left-${tone})" />

      <!-- Right Section -->
      <polygon points="${pTopRight} ${midRight} ${pCenter}" fill="url(#hs-facet-blue-right-${tone})" />
      <polygon points="${midRight} ${pBottomRight} ${midCenterRight} ${pCenter}" fill="url(#hs-facet-blue-right-${tone})" />
      <polygon points="${pBottomRight} ${midBottomRight} ${pCenter}" fill="url(#hs-facet-blue-dark-${tone})" />
      <polygon points="${midBottomRight} ${pBottom} ${pCenter}" fill="url(#hs-facet-blue-right-${tone})" />
...
// 1. Write full logo SVGs to public/assets/
writeFileSync(join(publicAssets, "hiresmart-ai-logo-light.svg"), createLogoSvg("light"));
writeFileSync(join(publicAssets, "hiresmart-ai-logo-dark.svg"), createLogoSvg("dark"));
writeFileSync(join(publicAssets, "hiresmart-ai-logo.svg"), createLogoSvg("light"));
writeFileSync(join(publicAssets, "hiresmart-cube.svg"), createCubeMarkSvg());

// 2. Also keep public/ root SVGs in sync
writeFileSync(join(publicRoot, "logo-full-light.svg"), createLogoSvg("light"));
writeFileSync(join(publicRoot, "logo-full.svg"), createLogoSvg("dark"));
writeFileSync(join(publicRoot, "logo-mark.svg"), createCubeMarkSvg());

console.log("Official brand assets built successfully!");
