...
const seedFreshData = async () => {
    ...
    const users = [
        ...
        },
        {
            ...
            companyDescription: "Leading global software engineering firm building scalable web & mobile platforms.",
        },
        {
            _id: recruiter2Id,
    ...
    const applications = [
        {
            ...
            statusHistory: [{ status: "Applied", changedBy: candidate1Id, note: "Application submitted" }],
        },
        {
            _id: mernAppId,
            job: mernJobId,
            ...
            statusHistory: [
                ...
                { status: "Shortlisted", changedBy: recruiter1Id, note: "Candidate shortlisted for technical interview" },
            ],
        },
        {
            _id: iosAppId,
