// Text utilities for the matching engine: tokenisation, stop-words,
// stemming, synonym normalisation, TF-IDF and cosine similarity.
// No API key or network needed - scoring always works offline.
